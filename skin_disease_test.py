...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "SKIN DISEASES PREDICTION"))
    ...
    def classifyFunction(self):
        ...
        label = ["cellulitis","impetigo","athlete_foot","nail_fungus","ringworm","cutaneous","chickenpox","shingles"]
    ...
    def trainingFunction(self):
        ...
        training_set = train_datagen.flow_from_directory('skin-disease-datasaet/train_set',
                                                         target_size = (128, 128),
                                                         batch_size = 8,
        ...
        test_set = test_datagen.flow_from_directory('skin-disease-datasaet/test_set',
                                                    target_size = (128, 128),
                                                    batch_size = 8,
                                                    class_mode = 'categorical')
